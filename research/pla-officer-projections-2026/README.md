...
**Principal sources.** *Official:* Ministry of National Defense, Xinhua, PLA Daily/81.cn, NPC Standing Committee gazettes, CPPCC Standing Committee decisions, CCDI and military-court releases, gov.cn; the PRC Law on Officers in Active Service and the NPCSC Decision of December 2016; and the US Department of Defense's annual *Military and Security Developments Involving the PRC* (2024 and 2025 editions). *Specialist analysis:* the China Aerospace Studies Institute at Air University — Kenneth Allen's work on grades, ranks and promotion analysis is the backbone of [`methodology.md`](methodology.md), and Margaret Kuntz's July 2026 study of PLA corruption supplied the turnover base rates; NDU Press (*Chairman Xi Remakes the PLA*) and INSS; *China Leadership Monitor* (Wuthnow, Czin); CSIS and its ChinaPower purge database; the China Maritime Studies Institute's "CMSI Notes" series (Erickson, Sharman, Shaw), which identified the current de facto Navy chief through protocol analysis; Jamestown's *China Brief*; Brookings; CNA; ASPI; War on the Rocks; NPC Observer for legislative tracking; and CCAS India's biographic compendium of the successor cohort. *Professional press:* Caixin, SCMP, Reuters, Financial Times, AP, NPR, VOA Chinese. *Biographical chronologies:* Chinese and English Wikipedia and Baidu Baike, tagged [WIKI] throughout — including the MediaWiki category-intersection technique described in [`succession-pipeline.md`](succession-pipeline.md) §1. *Émigré outlets* (Epoch Times, NTDTV, RFA Mandarin columns, Secret China, Aboluowang, Kanzhongguo, Wenxuecity) were used only as leads on officer disappearances, always tagged [RUMOR], and never treated as established.
