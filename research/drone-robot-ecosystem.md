...
**Loitering munitions / one-way attack.** The category Ukraine made famous, and China industrialized early, across a surprisingly deep bench of makers:
- **CASC's CH-901 / FH-901** (export BG-201) — a 9 kg, tube-launched Switchblade-class weapon (15 km radius, 120-min loiter); China [demonstrated a Dongfeng Mengshi truck with 48 CH-901 tubes](https://nationalinterest.org/blog/reboot/chinas-quest-loitering-munitions-aka-suicide-drones-168566) in 2020.
- **ASN Technology (Xi'an, tied to Northwestern Polytechnical University)** — historically China's highest-volume military UAV maker, whose **ASN-301** is a Harpy-class anti-radiation loitering munition for SEAD. NWPU is Entity-Listed; ASN is one of the most under-covered PLA drone primes.
- **The Zhuhai-2024 export tier** — the **WS-43** (~500 lb, 60 km), the **XS101** infantry loitering munition, and the truck-launched **[FL-300D](https://www.armyrecognition.com/news/army-news/2026/chinas-10k-truck-launched-fl-300d-drone-to-overwhelm-air-defenses-with-mass-saturation-strikes)** — a ~$10,000, ~1,000 km, 40–50 kg-payload one-way attack drone built for mass saturation.
- **Ziyan UAV (Zhuhai)** — the **Blowfish A2** armed unmanned helicopter (38 kg MTOW, 12 kg payload), marketed as swarm-capable and PLA-integrated.

Reporting points to a Chinese order approaching [~1 million loitering munitions by 2026](https://www.armyrecognition.com/news/army-news/2025/chinas-army-adopts-advanced-fpv-drone-tactics-reflecting-modern-warfare-lessons-from-ukraine). Below all of these sits the numberless FPV kamikaze tier drawn straight from the commercial supply chain.
...
**Military ground robots & exoskeletons — the part that's already fielded.** The commercial humanoid wave gets the headlines, but the PLA's *deployed* ground robots are more prosaic and further along:
- **Armed & combat UGVs.** NORINCO's **Sharp Claw** tracked robot (reconnaissance/light strike) is [reportedly fielded in Tibet at battalion scale](https://tibet.net/exclusive-chinese-army-using-robot-vehicles-in-tibet/) — ~88 units per some counts. The rocket-armed **ZRY222** tracked combat robot [appeared on state TV in January 2026](https://www.armyrecognition.com/news/army-news/2026/chinese-ground-units-test-zry222-rocket-armed-unmanned-ground-vehicle-for-infantry-close-support) integrated into infantry training, and the **Swarm-2** ground combat vehicle debuted at Zhuhai 2024. The September 2025 parade fielded a mixed wheeled/tracked/quadruped land-robot formation configurable with EO sensors, machine guns, rocket launchers, or small drones.
- **Logistics mules.** The tracked **Mule-200** (reportedly built by Zhongtian Zhikong) hauls ~200 kg over 50 km of rough terrain and is [deployed in Tibet by the dozen](https://tibet.net/exclusive-chinese-army-using-robot-vehicles-in-tibet/) — the unglamorous "last tactical mile" resupply role.
- **Armed quadrupeds ("war wolves").** [FDD's "War Wolves" analysis](https://www.fdd.org/analysis/2026/05/03/chinas-war-wolves-from-commercial-tech-to-combat-power/) tracks how commercial robot dogs (Unitree, DEEP Robotics) migrate straight into PLA squads carrying rifles and sensors — the single clearest MCF pipeline, since the platform ships from the same factory either way.
- **Exoskeletons.** NORINCO's passive load-bearing frame and CASIC's powered "Portable Ammunition Support Assist" suit are [in selective use in Tibet and Xinjiang](https://www.defenseone.com/technology/2025/08/iron-man-himalayas-chinas-pla-embraces-exoskeletons/407797/), where 4,500–5,500 m altitude wrecks troop endurance — a reminder that "embodied" also means augmenting the human.
...
What ties it all together is software and edge compute — and in 2025–26 it stopped being vaporware. The concrete systems:
- **CETC's "Atlas" swarm system** — demonstrated in a [full-chain operation in March 2026](https://www.armyrecognition.com/news/aerospace-news/2026/chinas-new-atlas-drone-swarm-system-demonstrates-how-algorithm-driven-warfare-becomes-operational): one operator, up to 96 drones, linking target ID → launcher activation → deployment → precision strike into a single automated sequence. This is the C2 layer that turns cheap airframes into a weapon system.
- **Resilient swarm autonomy** — China [showed a ~200-drone swarm controllable by a single soldier](https://www.tomshardware.com/tech-industry/china-reveals-200-strong-drone-swarm-uses-intelligent-algorithm-to-allow-individual-units-to-cooperate-autonomously-even-after-losing-communication-with-operator) whose "intelligent algorithm" lets units keep cooperating *after losing the operator link* — the hard problem (graceful degradation under jamming) that separates a demo from a doctrine.
- **Maritime crossover** — the **L30 USV swarm** ran its first operational autonomous patrol/interception test off Zhuhai, extending the same coordination logic to the sea (see the [naval map](./naval-undersea-suppliers.md)).

Underneath sits the model layer: the **vision-language-action (VLA)** models now driving both humanoids and drone swarms as a common brain, running on the [AI-compute stack](./chinese-military-supplier-map.md) — Huawei Ascend accelerators, Cambricon, DeepSeek-class domestic models on Ascend hardware — plus the edge silicon (Rockchip, Horizon) from Layer C. The airframes are commodities; **this** is where the next advantage is being contested, and it is the layer least visible to a component-by-component sanctions regime.
...
- **Magnets and rare earths.** The single most irreplaceable input to everyone else's drones and robots runs through a handful of Chinese producers — the "MAGnificent 6": **JL MAG** (~40 kt/yr, alone ~75% of China's 2021 output), **Zhongke Sanhuan** (~30–35 kt/yr, the world's largest sintered-NdFeB maker, with Chinese Academy of Sciences parentage that buys privileged rare-earth quota), **Ningbo Yunsheng**, **Zhenghai Magnet**, Yingluohua, and Earth Panda. The [April 2025 magnet-licensing regime](https://static.rusi.org/rp-drone-supply-chains-china-nov-2025_0.pdf) turned this into an active lever — by [December 2025 Beijing was issuing customer-specific export licenses](https://finance.yahoo.com/news/china-issues-first-batch-general-130729920.html) to JL MAG, Ningbo Yunsheng, and Zhongke Sanhuan, metering access buyer by buyer. It is already scrutinizing Ukraine's.
...
- FDD, [*China's War Wolves*](https://www.fdd.org/analysis/2026/05/03/chinas-war-wolves-from-commercial-tech-to-combat-power/); Army Recognition on the [ZRY222 combat UGV](https://www.armyrecognition.com/news/army-news/2026/chinese-ground-units-test-zry222-rocket-armed-unmanned-ground-vehicle-for-infantry-close-support) and [FL-300D](https://www.armyrecognition.com/news/army-news/2026/chinas-10k-truck-launched-fl-300d-drone-to-overwhelm-air-defenses-with-mass-saturation-strikes); Defense One on [PLA exoskeletons](https://www.defenseone.com/technology/2025/08/iron-man-himalayas-chinas-pla-embraces-exoskeletons/407797/); Central Tibetan Administration on [robot vehicles in Tibet](https://tibet.net/exclusive-chinese-army-using-robot-vehicles-in-tibet/)
- Army Recognition on the [CETC "Atlas" swarm system](https://www.armyrecognition.com/news/aerospace-news/2026/chinas-new-atlas-drone-swarm-system-demonstrates-how-algorithm-driven-warfare-becomes-operational) and Tom's Hardware on the [single-operator resilient swarm](https://www.tomshardware.com/tech-industry/china-reveals-200-strong-drone-swarm-uses-intelligent-algorithm-to-allow-individual-units-to-cooperate-autonomously-even-after-losing-communication-with-operator); MacroPolo and Yahoo Finance on the [NdFeB "MAGnificent 6" and Dec 2025 magnet licensing](https://finance.yahoo.com/news/china-issues-first-batch-general-130729920.html)
