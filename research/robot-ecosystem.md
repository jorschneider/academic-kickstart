...
- **The military handoff.** Chinese state TV has shown Unitree B1/B2 dogs **armed with mounted rifles** beside PLA troops, and FDD's "War Wolves" work traces how commercial robot dogs migrate straight into PLA squads — the clearest MCF pipeline on the board, because the platform ships from the same factory either way. A pointed irony: the underlying quadruped-locomotion research was [seeded by US DEVCOM Army Research Lab funding](https://www.militarytimes.com/industry/techwatch/2026/08/18/how-us-military-funding-propelled-chinas-robot-dogs/). Unitree insists its products are civilian and cites a 2022 no-weaponization pledge.
...
- **Reducers (the joint's precision heart).** **Leaderdrive / Green Harmonic (绿的谐波)** broke Japan's monopoly, taking **~30–40% of China's harmonic-reducer market** (J.P. Morgan) at **20–40% below** Japanese pricing, and supplying even Tesla; **Laifu, Beijing CTKM, and Hengfengtai** fill out the domestic field. But **Japan's Nabtesco (~22–25% of the global RV market) and Harmonic Drive still own the top precision tier** — the one genuine reducer dependency, narrowing but real.
...
The push is coordinated from the top: the **"mass-production year one"** framing, the first national **embodied-intelligence standard system**, national and local government guidance funds, and dense clusters in **Beijing, Shanghai, Shenzhen, Hangzhou, and Chongqing**. Robotics sits at the center of China's bid to define the next general-purpose technology platform.

## PLA, MCF & the sanctions wall

- **Unitree hit the 1260H list on June 8, 2026** — the Pentagon citing its indirect SASAC ownership, its "Little Giant" state support, and (per Kharon) partner-network ties to the PLA's **"Robot Wolf"** weapons platform. Days around it, the **FCC moved to bar Chinese humanoid robots** over backdoor concerns and the US **restricted imports of new Chinese robots** (late July 2026) — even as Unitree launched in Europe.
